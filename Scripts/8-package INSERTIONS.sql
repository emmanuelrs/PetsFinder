...
Procedure SET_USUARIO(nom in varchar2, nomusr in varchar2, contra in varchar2, tel in varchar2, email in varchar2, pais1 in varchar2, provincia1 in varchar2,
   canton1 in varchar2, distrito1 in varchar2, direc_exact in varchar2);

procedure SET_MASCOTA(nombre_m in varchar2, raza_m in varchar2, imagen_m in varchar2,  chip_ident in varchar2, color_m in varchar2,
