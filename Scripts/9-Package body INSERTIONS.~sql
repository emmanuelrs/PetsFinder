...
procedure SET_MASCOTA
  (nombre_m in varchar2, raza_m in varchar2, imagen_m in varchar2,  chip_ident in varchar2, color_m in varchar2,
 ...
 BEGIN
    ...
    insert into MASCOTA(ID_MASCOTA, TIPO, NOMBRE, TIPO_Y_RAZA, CHIP_IDENTIFICACION, COLOR, ESTADO, RECOMPENSA, DESCRIPCION)
           values(s_mascota.currval, 2, nombre_m, tipo_y_raza1, chip_ident, color_m, estado_m, recompensa1, descripcion);
    commit;
    exception
