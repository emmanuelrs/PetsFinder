...
<br></br>
    	...
    	<div class="span">   
    	<h1>Asociaciones pro el bienestar animal</h1>
		<br></br>    
        	<form id="contact-form" class="contact-form" action="registrar_asociacion.php" method = 'POST'>

            	<p class="contact-name">
            		<input id="contact_name" type="text" placeholder="Nombre de la Asociación" value="" name="nombre" />
                </p>
