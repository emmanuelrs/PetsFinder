...
$idMascota = $_POST['id_user'];
$division = '';    

$query_procedimiento = oci_parse($conn, "BEGIN :cursor :=consultas.coincidencias(:busq); END;");
$cursor = oci_new_cursor($conn);
oci_bind_by_name($query_procedimiento,':busq', $idMascota);
