...
<header>
    <div class="sticky-nav">
        ...
        <div id="logo">
        	<a id="goUp" href="#home-slider" title="Brushed | Responsive One Page Template">Pets Finder Costa Rica</a>
        </div>
        	...
        	<div class="span3">
                ...
                <nav id="options" class="work-nav">
                    <ul id="filters" class="option-set" data-option-key="filter">
                        ...
                        <li><a href="#filter" data-option-value="*" class="selected">Casas Cuna</a></li>
                        <li><a href="#filter" data-option-value=".design">Adopciones</a></li>
                        <li><a href="#filter" data-option-value=".photography">Calificaciones de adoptantes</a></li>
                        <li><a href="#filter" data-option-value=".video">Lista Negra</a></li>
                        <li><a href="#filter" data-option-value=".video">Donaciones</a></li>
                    </ul>
                </nav>
                <!-- End Filter -->
            </div>
